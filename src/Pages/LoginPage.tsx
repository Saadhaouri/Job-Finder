  ...
  return (
    <div className="2xl:container h-screen m-auto">
      <div hidden className="fixed inset-0 w-7/12 lg:block">
        <span className="absolute left-6 bottom-6 text-sm">Pexels</span>
        <img
      ...
      <div className="relative h-full ml-auto lg:w-6/12">
        <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2">
            <button className="py-3 px-6 rounded-xl bg-blue-50 hover:bg-blue-100 focus:bg-blue-100 active:bg-blue-200">
              <div className="flex gap-4 justify-center">
                <span className=" flex  items-center w-max font-medium  tracking-wide text-sm text-blue-700">
                  <FcGoogle className=" w-[38px] h-[28px]" /> with Google
                </span>
              </div>
            </button>
          ...
          <form action="" className="space-y-6 py-6">
            ...
            <div>
              <button className="w-full px-6 py-3 rounded-xl bg-blueColor transition hover:bg-sky-600 focus:bg-sky-600 active:bg-sky-800">
